...
privileged aspect AssignmentController_Roo_Controller {
    ...
    public String AssignmentController.create(@Valid Assignments assignments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AssignmentController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String AssignmentController.update(@Valid Assignments assignments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, assignments);
    ...
    void AssignmentController.populateEditForm(Model uiModel, Assignments assignments) {
